...
export function RecentDonors() {
  const initialDonors = [
    { name: 'Odunayo', amount: 1500, message: '' },
    { name: 'Fuhad Ola', amount: 2000, message: '' },
    { name: 'Towobola Christianah', amount: 2000, message: '' },
    { name: 'John Kenny', amount: 2000, message: '' },
    { name: 'Pst. Taiwo Daniel', amount: 50000, message: '' },
    { name: 'Godsent Evangelical Outreach (GEO)', amount: 20000, message: ''},
    ...
    { name: 'Abisayo T.', amount: 5000, message: '' },
    { name: 'Tosin', amount: 1300, message: '' },
    { name: 'Aderanti Temitope', amount: 10000, message: '' },
    ...
    { name: 'John David', amount: 1000, message: '' },
    { name: 'Abobarin.', amount: 5000, message: '' },
    { name: 'Abidemi', amount: 100, message: '' },
  ...
  const initialTop = [
    ...
    { name: 'Pst. Taiwo Daniel', amount: 50000 },
